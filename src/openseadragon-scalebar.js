...
(function($) {
    ...
    $.ScalebarSizeAndTextRenderer = {
         ...
         * minute, hour, day and year.
         */
        STANDARD_ANGLE: function(pparcsec, minSize) {
            var maxSize = minSize * 2;
            if (maxSize < pparcsec * 60) {
                return getScalebarSizeAndTextForMetric(pparcsec, minSize, '"', false);
            }
            var pparcmin = pparcsec * 60;
            if (maxSize < pparcmin * 60) {
                return getScalebarSizeAndText(pparcmin, minSize, "'", false);
            }
            var ppdeg = pparcmin * 60;
            return getScalebarSizeAndText(ppdeg, minSize, '°', false);
        },
        /**
